...
PLATFORM_IMAGE_SIZES = {
    ...
    "instagram_story": os.getenv("OPENAI_IMAGE_SIZE_INSTAGRAM_STORY", "1024x1536"),  # Vertical format
    "twitter": os.getenv("OPENAI_IMAGE_SIZE_TWITTER", "1536x1024"),  # Landscape format (closest to 16:9)
    "tiktok": os.getenv("OPENAI_IMAGE_SIZE_TIKTOK", "1024x1536"),  # Vertical format
}
